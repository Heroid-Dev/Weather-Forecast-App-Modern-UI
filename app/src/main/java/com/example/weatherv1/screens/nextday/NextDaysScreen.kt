...
//                    onCardClicked = {},
//                    time = "Tomorrow",
//                    weatherImage = getWeatherIconFromCondition(tomorrowDayInfo.icon),
//                    maxTemp = if (unitPref.isFahrenheit)
//                        celsiusToFahrenheit(tomorrowDayInfo.tempmax).toInt()
//                            .toString() + "F"
//                    else
//                        "${tomorrowDayInfo.tempmax.toInt()}°",
//                    minTemp = if (unitPref.isFahrenheit)
//                        celsiusToFahrenheit(tomorrowDayInfo.tempmin).toInt()
//                            .toString() + "F"
//                    else
//                        "${tomorrowDayInfo.tempmin.toInt()}°",
//                    status = tomorrowDayInfo.conditions,
//                    humidity = tomorrowDayInfo.humidity.toInt(),
//                    Precipitation = if (unitPref.inRain_mm) "${tomorrowDayInfo.precip.toInt()}mm" else "${tomorrowDayInfo.precipprob.toInt()}%",
